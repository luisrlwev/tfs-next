...
const slides = [
    { src: '/img/index/balche/balche-1.jpg', type: 'image' },
    { src: '/img/index/balche/balche-2.jpg', type: 'image' },
    { src: '/video/balche.mp4', type: 'video', poster: '/img/index/balche/balche-3.jpg' },
  ];

export default function GaleriaBalche() {
