...
const slides = [
    { src: '/img/index/6-rios/6-rios-1.jpg', type: 'image' },
    { src: '/img/index/6-rios/6-rios-2.jpg', type: 'image' },
    { src: '/video/6-rios.mp4', type: 'video', poster: '/img/index/6-rios/6-rios-3.jpg' },
  ];

export default function Galeria6Rios() {
