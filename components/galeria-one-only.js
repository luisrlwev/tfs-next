...
const slides = [
    { src: '/img/index/one-only/one-only-1.jpg', type: 'image' },
    { src: '/img/index/one-only/one-only-2.jpg', type: 'image' },
    { src: '/video/one-only.mp4', type: 'video', poster: '/img/index/one-only/one-only-3.jpg' },
  ];

export default function GaleriaOneOnly() {
