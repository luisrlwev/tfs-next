  ...
  return (
    <footer>
      <div className="bg-header py-10">
        <div className="grid grid-cols-3 gap-3 container xl mx-auto">
          <div>
          ...
          <div className="grid content-center px-3">
            <p className="text-center text-white uppercase font-bold letter-spacing-25 pb-8 w-full">Licencias Certificadas</p>
          ...
          <div className="grid justify-center items-center">
            <Link href={'/'} className="h-max"><Image src={'/img/logo.svg'} width={354} height={201} alt="Logo TFS"/></Link>
            <div className="grid grid-cols-7 justify-items-center text-tfs text-3xl h-max">
      ...
      <div className="text-white text-center text-base py-4 bg-footer">
        <p className="font-bold uppercase text-footer letter-spacing-25 pb-2">Tulumfromsky Realtors © 2023 Todos los derechos reservados JAH OLAM SA DE CV</p>
        <Link href={'/aviso-de-privacidad'} className="underline">Aviso de privacidad</Link>
      </div>
    </footer>
  );
}
