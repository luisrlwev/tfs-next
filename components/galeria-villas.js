...
const slides = [
    { src: '/img/index/villas-ixtul/villas-ixtul-1.jpg', type: 'image' },
    { src: '/img/index/villas-ixtul/villas-ixtul-2.jpg', type: 'image' },
    { src: '/video/villas-ixtul.mp4', type: 'video', poster: '/img/index/villas-ixtul/villas-ixtul-3.jpg' },
  ];

export default function GaleriaVillas() {
